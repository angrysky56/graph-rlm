...
async def build_system_prompt(
    ...
    prompt = (
        ...
        "You are operating a stateless agent framework in a Global Workspace. Your context is managed SYMBOLICALLY via a persistent REPL.\n"
        ...
        "\n"
        "**DASHBOARD (Current Gestalt Scores)**:\n"
