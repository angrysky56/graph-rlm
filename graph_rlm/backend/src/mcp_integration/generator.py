...
class ToolGenerator:
    ...
    def __init__(
        ...
        runtime_package: str = "graph_rlm.backend.src.mcp_integration",
    ) -> None:
        """
        ...
        Args:
            ...
            runtime_package: Base package path for runtime and utils
        """
...
{docstring}
    from {self.runtime_package}.runtime import call_mcp_tool
    from {self.runtime_package}.utils import normalize_mcp_result
    import asyncio
...
from typing import Any
from {self.runtime_package}.runtime import call_mcp_tool as call_tool
...
def run_skill(name: str, args: dict | None = None) -> Any:
    ...
    """
    import asyncio
    from {self.runtime_package}.skill_harness import execute_skill
...
def generate_from_config(
    ...
    generator = ToolGenerator(output_dir, runtime_package=runtime_package)
