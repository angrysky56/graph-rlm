...
class SandboxConfig(BaseModel):
    ...
    max_timeout: int = Field(
        default=120, description="Maximum allowed timeout in seconds"
    )
...
class McpConfig(BaseModel):
    ...
    def from_dict(cls, config_dict: dict[str, Any]) -> "McpConfig":
        ...
        """
        return cast("McpConfig", cls.model_validate(config_dict))
    ...
    def from_json(cls, json_str: str) -> "McpConfig":
        ...
        """
        return cast("McpConfig", cls.model_validate_json(json_str))
