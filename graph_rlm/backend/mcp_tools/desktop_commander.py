"""
Auto-generated wrapper for desktop-commander MCP server.

This module provides Python function wrappers for all tools
exposed by the desktop-commander server.
